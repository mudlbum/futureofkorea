---
title: "How to buy Korean stocks from abroad in 2026: ADRs, ETFs and direct access, compared"
slug: how-to-buy-korean-stocks-from-abroad
seo_title: "How to Buy Korean Stocks From Abroad (2026)"
...
faq:
  - q: "Can I just buy Samsung Electronics from a US brokerage account?"
    a: "Not cleanly. Samsung Electronics does not maintain a sponsored ADR listed on the NYSE or Nasdaq. The ticker people find — SSNLF — is an unsponsored over-the-counter line that trades thinly, often with a wide spread and stale pricing, and many brokers restrict or refuse it. The realistic routes to Samsung exposure are a Korea ETF (where it is typically the largest holding), a broker offering true international market access to the KRX, or a London/Frankfurt-listed GDR where available."
  - q: "Do I still need an Investment Registration Certificate?"
    a: "No. Korea removed the IRC requirement for foreign investors in 2023 as part of the market-access reforms aimed at index reclassification. Foreign institutions now identify using a Legal Entity Identifier, and individual non-residents register through their broker. The IRC is one of the most persistent pieces of outdated advice on the internet about this market."
  - q: "Which is better, EWY or a direct account?"
    a: "For nearly everyone reading this in English from outside Korea: the ETF. A US-listed Korea ETF gives you same-day liquidity, dollar settlement, no local tax filing, no FX account, and an expense ratio typically well under 0.7%. A direct KRX account is worth the friction only if you need single-stock precision, want small and mid caps the ETF doesn't hold, or are investing enough that the fee saving outweighs several hours of paperwork and ongoing tax complexity."
  - q: "How is my dividend taxed?"
    a: "Korea applies withholding tax at source on dividends paid to non-residents. The headline domestic rate is reduced under most double-taxation treaties — commonly to 15% for portfolio holdings — but the applicable rate depends on your country of residence and on your broker having filed the correct treaty documentation on your behalf. Confirm the rate your custodian is actually applying; if it is withholding at the full domestic rate because paperwork is missing, you are leaving money behind. This is general information, not tax advice."
  - q: "Is currency risk hedged in these products?"
    a: "Usually not. Standard Korea ETFs are unhedged, so your return is the local equity return multiplied by the KRW/USD move. Currency-hedged share classes exist in some markets. Given how much the won moved in 2026, this is a decision to make deliberately rather than by default."
  - q: "What is the minimum realistic amount to invest?"
    a: "Via an ETF, one share — typically double-digit dollars. Via a direct KRX account, the practical floor is much higher because account opening, FX conversion spreads and custody costs are fixed rather than proportional. Below roughly $25,000 the direct route rarely justifies itself."
resources:
  - title: "Korea Exchange — foreign investor information (English)"
    url: "https://global.krx.co.kr/"
    note: "Official market rules, trading hours, settlement cycle and listing data."
  - title: "Financial Supervisory Service — DART disclosure system"
    url: "https://dart.fss.or.kr/"
    note: "Every listed Korean company's filings. The English portal covers major disclosures."
  - title: "National Tax Service — international taxation (English)"
    url: "https://www.nts.go.kr/english/"
    note: "Withholding rates and Korea's double-taxation treaty network. English helpline: 126."
  - title: "Bank of Korea — exchange rate statistics"
    url: "https://ecos.bok.or.kr/"
    note: "Official USD/KRW series, for checking what your broker's FX spread is really costing you."
  - title: "Korea Securities Depository (KSD)"
...
Read the [disclaimer](/disclaimer/) first: none of this is investment advice, and the Korean market has just demonstrated exactly how violent it can be.
...
> [!TIP] Check the concentration before you buy
> Pull the fund's holdings page and look at the top two weights. If they exceed 30% combined — and for broad Korea funds they typically do — you are running single-name risk inside something that looks like a diversified product. Some issuers now offer capped or equal-weight Korea funds specifically to address this.
...
> [!WARNING] Samsung Electronics does not have a normal US listing
> There is no sponsored Samsung Electronics ADR on the NYSE or Nasdaq. The ticker that turns up in search results — **SSNLF** — is an *unsponsored over-the-counter* line. It trades thinly, prices can be stale, spreads can be brutal, and a number of brokers restrict or decline it outright. It is not a sensible way to own Samsung. If you want Samsung exposure from abroad, use a Korea ETF, a broker with genuine KRX access, or a London/Frankfurt-listed GDR where your broker offers one.
...
Trading runs **09:00–15:30 KST**, with settlement on a **T+2** basis. Korea also operates daily price limits and index-level circuit breakers — a feature the market exercised repeatedly in July and August 2026, as we covered in [the 2026 crash explainer](/markets/kospi-crash-2026-explained/).
...
> [!KEY] The number to internalise
> An unhedged foreign investor's return = local equity return × currency move. In the first half of 2026, foreign holders of Korean equities watched a near-doubling index and *still* sold a record ₩148.3tn — currency and benchmark-weight mechanics were a substantial part of why.
...
Before sizing anything, understand what you are actually buying exposure to. Korea's index is a memory-semiconductor bet in practice — our piece on [the HBM4 handover](/technology/hbm4-2026-sk-hynix-samsung-micron/) covers the competitive position underneath it, and [the won explainer](/policy/korea-won-weakness-fx-reform-2026/) covers the currency leg, including the FX market infrastructure changes arriving in September 2026 that may make direct access materially easier.
